...
public class AddPolyTest {
    ...
    public void addPoly(String pol1, String poli2, String polRes) throws PolynomialException {
        ...
        Polynomial resTest;
        resTest = operations.addPoly(firstPoly, secondPoly);
        resTest.showMono();
        result.showMono();
        Assertions.assertEquals(resTest, result, "Addition is bad");
    }
    private static List<Arguments> provideInput() {
        ...
        argumentsList.add(Arguments.of("+x^2+1", "+x^2+1", "+2x^2+2"));
